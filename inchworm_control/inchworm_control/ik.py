...
def adjust_positions(goal_X: float, goal_Y: float, goal_Z: float, which_foot_motor: int): 
        ...
        Args:
            ...
            which_foot_motor (int): Motor identifier (1 or 5) corresponding to the pivotal foot.
        Returns: 
            list: 3x1 list 
        """
...
def inverseKinematics(Px, Py, Pz, alpha, which_foot_motor):
    ...
    # [Px, Py, Pz] = adjust_positions(Px, Py, Pz, which_foot_motor)    
