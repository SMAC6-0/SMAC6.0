...
def adjust_positions(goal_X: float, goal_Y: float, goal_Z: float, alpha: float, pivot_foot: int): 
        ...
        if (pivot_foot == 1):
            ...
            if goal_Y > -0.5 and goal_Y <= 0.5: # y = 0
                if goal_X > 0.9 and goal_X <= 1.5: # x = 1
                    if goal_Z > -0.1 and goal_Z <= 0.01: # z = 0 # CHeck this again
                        ...
                        inputAlpha = alpha - 2
                        adjustedAlpha = True
                    elif goal_Z > 1.25 and goal_Z <= 2: # z = 1.5
                        inputX = CUBE_WIDTH * goal_X + 1.3
            ...
            # Here are the turns
                ...
                if goal_Z > -0.1 and goal_Z <= 0.25: # z = 0
                    inputX = CUBE_WIDTH * goal_X - 2.5
                    inputY = CUBE_WIDTH * goal_Y - 2.0
                    inputZ = CUBE_WIDTH * goal_Z - 0.2
                    inputAlpha = alpha - 2
                    adjustedAlpha = True
                elif goal_Z > 0.25 and goal_Z <= 0.75: # z = 0.5
...
def inverseKinematics(Px, Py, Pz, alpha, pivot_foot: int, fix_EE_orientation: bool):
    ...
    [Px, Py, Pz, alpha] = adjust_positions(Px, Py, Pz, alpha, pivot_foot)    
