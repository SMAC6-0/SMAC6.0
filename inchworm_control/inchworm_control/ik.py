...
def adjust_positions(goal_X: float, goal_Y: float, goal_Z: float): 
        """
...
def inverseKinematics(Px, Py, Pz, alpha, which_foot_motor):
    ...
    if which_foot_motor == 1:
        ...
        if (Py < 0):
            ...
            theta5 = m-ath.atan2(y, Px/r) 
    
        # Final joint angles
        theta4 = r-ound(math.pi/2 - (beta + gamma), 2)
        theta2 = r-ound(theta4 + theta3 - alpha - math.pi/2, 2)
