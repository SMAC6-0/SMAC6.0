...
GRID_SIZE = 15  # Define the size of your grid in one direction 
...
### INCHWORMS ###
IW_1_LOC = [14, 14, 0] # Starting location of the inchworm robot, where the coordinates are represented as (x, y, z).
IW_2_LOC = [4, 2, 0]
