...
def initiate_find_path(grid, leading_foot_loc, lagging_foot_loc, path_end, curr_orientation: InchwormOrientation, holding_block: bool, iw_id: int, priority_queue, bypass_flag=False):
    """
